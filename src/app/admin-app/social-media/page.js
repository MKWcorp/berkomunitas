...
export default function SocialMediaPage() {
  ...
  useEffect(() => {
    console.log('⚡ isAdmin effect triggered. isAdmin:', isAdmin);
    if (isAdmin) {
      console.log('🚀 Admin confirmed, fetching social medias...');
      fetchSocialMedias();
    }
  }, [isAdmin]);
  ...
  async function checkAdminAccess() {
    ...
    try {
      ...
      console.log('👮‍♂️ Admin check response:', res.status, 'OK:', res.ok);
